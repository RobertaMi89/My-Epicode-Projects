            ...
            <Col>
              ...
              >
                <svg
                  ...
                  height="30"
                  fill="currentColor"
                  className="bi bi-facebook text-secondary mx-1"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="30"
                  fill="currentColor"
                  className="bi bi-instagram text-secondary mx-1"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="30"
                  fill="currentColor"
                  className="bi bi-twitter text-secondary mx-1"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.youtube.com/c/netflixitalia"
                target="_blank"
                className="text-decoration-none"
              >
                <svg
                  ...
                  height="30"
                  fill="currentColor"
                  className="bi bi-youtube text-secondary mx-1"
                  viewBox="0 0 16 16"
                >
              ...
              <p className="text-secondary mt-2">Audio and Subtitles</p>
